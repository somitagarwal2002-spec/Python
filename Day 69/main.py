...
class Base(DeclarativeBase):
    pass
app.config['SQLALCHEMY_DATABASE_URI'] = "sqlite:////Users/somitagarwal/Desktop/Python/Day 69/instance/blog.db"
...
class Comment(db.Model):
    ...
    post_id: Mapped[str] = mapped_column(String, db.ForeignKey("blog_posts.id"))
...
def admin_only(f):
    ...
    def decorated_function(*args, **kwargs):
        # if id is not 1 then abort or error 403
        if current_user.id != 1:
            return abort(403)
        # else wo admin hi hai
